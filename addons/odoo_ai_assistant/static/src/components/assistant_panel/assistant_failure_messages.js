...
const FAILURE_MESSAGES = {
    ...
    engine_timeout: _t(
        "La petición se ha quedado sin tiempo antes de terminar. No doy ningún resultado ni cambio por confirmado. Si era una consulta puedes reintentarlo; si pedías modificar datos, comprueba primero su estado actual."
    ),
