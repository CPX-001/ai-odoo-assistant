...
class TestCodexDecisionAdapter(BaseCase):
    ...
    def test_codex_instructions_keep_task_plan_non_authoritative_and_effect_steps_distinct(self):
        ...
        self.assertIn("Never describe a partial receipt as complete success", instructions)
        self.assertIn("offer the safest useful next action", instructions)
        self.assertIn("Use the available read capabilities", instructions)
