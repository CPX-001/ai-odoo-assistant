        ...
        *,
        ...
        effective_evidence_ids = (
            tuple(
                ...
                if item in available_evidence_set
            )
...
def compose_assistant_extensions(
    ...
    *,
    ...
    required providers fail closed. Built-in Evidence providers enter this same
    catalog rather than a parallel tool or retrieval registry.
    """
