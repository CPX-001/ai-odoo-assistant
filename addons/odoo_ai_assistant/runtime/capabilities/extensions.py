...
class ActiveAssistantExtensions:
    ...
    def host_skill_contract(self) -> tuple[dict[str, JsonValue], ...]:
        """Trusted guidance; authority remains the effective capability catalog."""
    ...
    def untrusted_context_data(self) -> tuple[dict[str, JsonValue], ...]:
        """JIT context is projected as data, never as host instructions."""
...
class AssistantExtensionCatalog:
    ...
    evidence_providers: EvidenceProviderCatalog = EvidenceProviderCatalog()
    ...
    def activate(
        ...
        *,
        ...
        """Resolve Skills, JIT context and effective Evidence provider metadata."""
        ...
        requested_evidence_ids = tuple(evidence_provider_ids)
        effective_evidence_ids = (
            tuple(
                item
                for item in requested_evidence_ids
                if item in set(available_evidence_ids)
            )
    ...
    def search_evidence(
        ...
        *,
        ...
        """Provider-neutral P8 routing seam with optional bounded ledger capture."""
...
def compose_assistant_extensions(
    ...
    *,
    ...
    A provider whose executable contract failed cannot contribute instructions,
    context or Evidence. Identity conflicts are isolated for optional providers;
    required providers fail closed. Built-in Evidence providers are host-owned and
    enter through this same catalog rather than a second registry.
    """
...
def discover_assistant_extensions_for_env(
    ...
    *,
    ...
    """Discover resources from the effective Odoo registry plus core Evidence."""
