...
| M1 — Runtime / install | Service instalable, con runtime y DB propios, detectado como healthy desde Odoo. |
...
| M3 — Source + logs | Encontrar `action_confirm` y un traceback desde Diagnostics con evidencia acotada. |
...
| M7 — Product hardening | Permitir que un técnico instale, actualice y opere el piloto sin consola diaria, con Diagnostics y tests de seguridad. |
