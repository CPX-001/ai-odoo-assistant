...
- [`tasks/M6/README.md`](tasks/M6/README.md): M6-01..M6-10 implementadas; gate FAIL documentado y milestone todavía abierto.
...
M5 está cerrado con gate PASS. M6 tiene sus diez packets implementados, pero sigue abierto según `docs/M6_GATE_REPORT.md`; no avanzar a M7 hasta resolver los blockers y cerrar M6 con gate PASS.
