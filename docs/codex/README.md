...
- [`tasks/M0/README.md`](tasks/M0/README.md): milestone M0 completado y detalle de su gate.
...
Ejecutar una sola task del milestone activo cada vez y no avanzar automáticamente a la siguiente sin verificar sus acceptance criteria.
