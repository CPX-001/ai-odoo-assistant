...
- [`tasks/M0/README.md`](tasks/M0/README.md): milestone activo y orden de tasks de M0.
- [`../../PLANS.md`](../../PLANS.md): cuándo y cómo mantener un ExecPlan.

Antes de implementar, contrastar siempre el task packet con el Source of Truth y los ADRs aplicables. Ejecutar una sola task del milestone activo cada vez y no avanzar automáticamente a la siguiente sin verificar sus acceptance criteria.
