...
- [`tasks/M5/README.md`](tasks/M5/README.md): M5-01 a M5-07 implementadas y verificadas; M5-08 es la siguiente task.
...
M5 está en curso. Ejecutar una sola task cada vez y no avanzar automáticamente a la siguiente sin verificar sus acceptance criteria.
