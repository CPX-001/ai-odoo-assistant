...
- [`tasks/M2/README.md`](tasks/M2/README.md): milestone activo; task packets de UI, contexto y delegación. La implementación todavía no se ha iniciado.
...
M2 es el milestone activo. Ejecutar una sola task cada vez y no avanzar automáticamente a la siguiente sin verificar sus acceptance criteria.
