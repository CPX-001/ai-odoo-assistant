...
prepared after P7. It follows the product decisions in the adapted architecture
packet without claiming later P8 source/log/observability functionality complete.
...
- provider API version/reserved namespaces;
