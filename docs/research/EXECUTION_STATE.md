...
`docs/research/P8_FOCUSED_VALIDATION_RUNBOOK.md`. A full regression is not
authorized merely because this checkpoint was merged; expand only for a concrete
failure or an explicit runbook requirement.
