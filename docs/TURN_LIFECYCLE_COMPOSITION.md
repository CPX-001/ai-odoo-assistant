...
6. activate Skills against the effective capability/context/evidence catalogs
...
partition. The Codex adapter receives only the provider-neutral partitions produced
by the host.
